...
electron.contextBridge.exposeInMainWorld("electron", {
  ...
  deletePiece: (req) => electron.ipcRenderer.invoke("deletePiece", req),
  ...
  deleteSession: (req) => electron.ipcRenderer.invoke("deleteSession", req),

  updateSubsessionTime: (req) =>
    electron.ipcRenderer.invoke("updateSubsessionTime", req),
  startSession: (req) => electron.ipcRenderer.invoke("startSession", req),
  ...
  //----Term Routes----
  getAllTerms: () => electron.ipcRenderer.invoke("getAllTerms"),
